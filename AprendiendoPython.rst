 ...
 * [[http://greenteapress.com/thinkpython/thinkpython.html|How to Think Like a Computer Scientist]] (Python 2.x) es de conceptos generales de programación usando Python.  Hay una versión en español llamada [[http://web.ballardini.com.ar/ai/raw-attachment/wiki/BibliografiaPython/thinkCSpy-es.pdf|Aprenda a pensar como un programador (con Python)]].
