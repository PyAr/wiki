 ...
 * [[http://openbookproject.net/thinkcs/python/english2e/|How to Think Like a Computer Scientist]] (Link Roto) es de conceptos generales de programación usando Python.  Hay una versión en español llamada [[http://manuales.gfc.edu.co/python/tlc/thinkCSpy.es.pdf|Aprenda a pensar como un programador (con Python)]].
