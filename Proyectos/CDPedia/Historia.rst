...
Cuenta la leyenda que el proyecto arrancó en el sprint posterior al primer PyDay de Santa Fé, en Junio del 2006.

Las mejoras en el proyecto fueron muy por ráfagas. Aunque siempre se trabajó mucho en este proyecto durante los PyCamps (los dos en Los Cocos, el de Verónica, y el de La Falda), donde muchas personas le dedicaron un buen tiempo, también se realizó bastante durante otras reuniones, especialmente durante el 2010 y 2011.
...
Con todo este trabajo, y un nuevo "empujón" en el PyCamp del 2011, pudimos terminar de cerrar la versión 0.7, que se entregó a Educ.ar y debería estar distribuyendo por estas semanas a todas las escuelas del pais.
