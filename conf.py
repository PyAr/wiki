...
BLOG_AUTHOR = "Python Argentina"  # (translatable)
BLOG_TITLE = "Python Argentina Wiki"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://wiki.python.org.ar/"
...
BODY_END = BODY_END + FLEXSEARCH_OVERLAY