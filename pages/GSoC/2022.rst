...
.. class:: alert alert-info
  ...
  | For + Info see bellow: `About Python Argentina <#about-python-argentina>`_ (`Contactiong Us <#contacting-us>`_) - `Getting Started <#getting-started>`_ - `Important notes <#important-notes>`_
