...
- Potential mentor: Mariano Reingart (coordinator, please contact the `PyAr GSoC Telegram group <https://t.me/+ljnpIYBUMLI3MDAx>`__)
...
- Project ideas: 
    ...
    - Milestone `Stabilization <https://github.com/facundobatista/pyempaq/milestone/6>`__: GUI; Windows; GitHub Actions Ubuntu (Snap); support setup.py / setup.cfg and pyproject.toml
...
- Potential mentor: Facundo Batista (coordinator, please contact the `PyAr GSoC Telegram group <https://t.me/+ljnpIYBUMLI3MDAx>`__)
...
- Potential mentor: Marian-vignau (coordinator, please contact the `PyAr GSoC Telegram group <https://t.me/+ljnpIYBUMLI3MDAx>`__)
...
- Potential mentor: reingart (coordinator, please contact the `PyAr GSoC Telegram group <https://t.me/+ljnpIYBUMLI3MDAx>`__)
