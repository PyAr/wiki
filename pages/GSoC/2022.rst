...
.. class:: alert alert-info
  ...
  | For + Info see bellow: :ref:`About Python Argentina` (:ref:`Contacting Us`) - :ref:`Getting Started` - :ref:`Important notes`_ | `Info En Español <https://wiki.python.org.ar/gsoc>`_
