...
- Ideas: 
    - Unit Testing: extend unit tests coverage to 70% (including command-line tools)
    - Automation: build windows installers in continuous integration
    - Webservice simulator: fake implementation for testing, mimicking government servers
