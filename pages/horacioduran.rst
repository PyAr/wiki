...
En 2004 mas o menos, empecé a trabajar en el proyecto PAPO de la `Fundación Via Libre`_, puntualmente en Luca un software de administración de recursos contables para PyMes (en Python, evidentemente), en ese momento conocí python y nunca mas lo dejé.
