...
GSoC 2024 PyAr projects
=======================

.. class:: alert alert-info

  | The following are the Python Argentina projects that could participate in Google Summer of Code 2024 (under the `PSF org <https://python-gsoc.org/>`_).
  | Ideas are tentative, please engage with the community strongly to present and improve your original proposals.
  | For + Info see bellow: `About Python Argentina <https://wiki.python.org.ar/GSoC/2024#about-python-argentina-1>`_ (`Contacting Us <https://wiki.python.org.ar/GSoC/2024#contacting-us-1>`_) - `Getting Started <https://wiki.python.org.ar/GSoC/2024#getting-started-1>`_ - `Important notes <https://wiki.python.org.ar/GSoC/2024#important-notes>`__ | `Info En Español <https://wiki.python.org.ar/gsoc>`_
...
- Past GSoC Students projects wrap-up (for reference):
    - `Sujith <https://github.com/PyAr/PyZombis/wiki/GSoC'23-PSF-@-PyAr-PyZombis-Final-Submission-Report>`_ (2023)
...
- Project Ideas: 
    - Unit Testing: extend unit tests coverage beyond 70% (including command-line tools, see `#107 <https://github.com/PyAr/pyafipws/issues/107>`_ as an example and report.html in GitHub Actions workflow)
