...
Todos con IVA incluidos. Estos son precios a pagar por transferencia, también podes por Mercadopago (lo cual permite usar tarjetas, etc.) el cual tiene un pequeño incremento por el costo de esa plataforma.Estos son precios a pagar por transferencia, también podes por Mercadopago (lo cual permite usar tarjetas, etc.) el cual tiene un pequeño incremento por el costo de esa plataforma.
