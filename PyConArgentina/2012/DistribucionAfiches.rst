...
'''Importante:''' para simplificar, usamos como base la página de distribución de tutoriales [[http://python.org.ar/pyar/Proyectos/UnManualEnCadaUniversidad|UnManualEnCadaUniversidad]], si no estas interesado, simplemente elimina tu nombre del listado, y si no estás y quieres agregarte, simplemente hazlo ;-)
