...
* Rediseñar/Diseñar/Pulir y/o implementar la parte del backend (tal vez utilizar Pyro4).
...
La intención es automatizar la descarga de imágenes satelitales del satélite GOES-13 desde el sitio web del NOAA (National Oceanic and Atmospheric Administration). El repositorio se llama [[https://github.com/ecolell/solar_radiation_model|solar_radiation_model]]).
